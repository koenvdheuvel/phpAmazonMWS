...
<ErrorResponse xmlns="http://mws.amazonaws.com/doc/2009-01-01/">
  ...
  <RequestID>123</RequestID>
     ...
     * @param string|\AmazonMWSConfig $config <p>The path to the config file.</p>
     ...
     * @param string $storeName [optional] <p>The store name to look for.
     ...
     * @return array|bool associative array of HTTP response or <b>FALSE</b> if not set yet
     */
     ...
     * @return array|bool list of associative arrays of HTTP response or <b>FALSE</b> if not set yet
     * @see getLastResponse
     */
